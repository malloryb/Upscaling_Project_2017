...
GlobalAnalysis(1309, 1, 2001, 01, "Jan", 07)
GlobalAnalysis(1310, 2, 2001, 02, "Feb", 08)
GlobalAnalysis(1311, 3, 2001, 03, "Mar", 09)
GlobalAnalysis(1312, 4, 2001, 04, "Aor", 10)
GlobalAnalysis(1313, 5, 2001, 05, "May", 11)
GlobalAnalysis(1314, 6, 2001, 06, "Jun", 12)
GlobalAnalysis(1315, 7, 2001, 07, "Jul", 01)
GlobalAnalysis(1316, 8, 2001, 08, "Aug", 02)
GlobalAnalysis(1317, 9, 2001, 09, "Sep", 03)
GlobalAnalysis(1318, 10, 2001, 10, "Oct", 04)
GlobalAnalysis(1319, 11, 2001, 11, "Nov", 05)
GlobalAnalysis(1320, 12, 2001, 12, "Dec", 06)

GlobalAnalysis(1309, 13, 2002, 01, "Jan", 07)
GlobalAnalysis(1310, 14, 2002, 02, "Feb", 08)
GlobalAnalysis(1311, 15, 2002, 03, "Mar", 09)
GlobalAnalysis(1312, 16, 2002, 04, "Aor", 10)
GlobalAnalysis(1313, 17, 2002, 05, "May", 11)
GlobalAnalysis(1314, 18, 2002, 06, "Jun", 12)
GlobalAnalysis(1315, 19, 2002, 07, "Jul", 01)
GlobalAnalysis(1316, 20, 2002, 08, "Aug", 02)
GlobalAnalysis(1317, 21, 2002, 09, "Sep", 03)
GlobalAnalysis(1318, 22, 2002, 10, "Oct", 04)
GlobalAnalysis(1319, 23, 2002, 11, "Nov", 05)
GlobalAnalysis(1320, 24, 2002, 12, "Dec", 06)

GlobalAnalysis(1309, 25, 2003, 01, "Jan", 07)
GlobalAnalysis(1310, 26, 2003, 02, "Feb", 08)
GlobalAnalysis(1311, 27, 2003, 03, "Mar", 09)
GlobalAnalysis(1312, 28, 2003, 04, "Aor", 10)
GlobalAnalysis(1313, 29, 2003, 05, "May", 11)
GlobalAnalysis(1314, 30, 2003, 06, "Jun", 12)
GlobalAnalysis(1315, 31, 2003, 07, "Jul", 01)
GlobalAnalysis(1316, 32, 2003, 08, "Aug", 02)
GlobalAnalysis(1317, 33, 2003, 09, "Sep", 03)
GlobalAnalysis(1318, 34, 2003, 10, "Oct", 04)
GlobalAnalysis(1319, 35, 2003, 11, "Nov", 05)
GlobalAnalysis(1320, 36, 2003, 12, "Dec", 06)

GlobalAnalysis(1309, 37, 2004, 01, "Jan", 07)
GlobalAnalysis(1310, 38, 2004, 02, "Feb", 08)
GlobalAnalysis(1311, 39, 2004, 03, "Mar", 09)
GlobalAnalysis(1312, 40, 2004, 04, "Aor", 10)
GlobalAnalysis(1313, 41, 2004, 05, "May", 11)
GlobalAnalysis(1314, 42, 2004, 06, "Jun", 12)
GlobalAnalysis(1315, 43, 2004, 07, "Jul", 01)
GlobalAnalysis(1316, 44, 2004, 08, "Aug", 02)
GlobalAnalysis(1317, 45, 2004, 09, "Sep", 03)
GlobalAnalysis(1318, 46, 2004, 10, "Oct", 04)
GlobalAnalysis(1319, 47, 2004, 11, "Nov", 05)
GlobalAnalysis(1320, 48, 2004, 12, "Dec", 06)

GlobalAnalysis(1309, 49, 2005, 01, "Jan", 07)
GlobalAnalysis(1310, 50, 2005, 02, "Feb", 08)
GlobalAnalysis(1311, 51, 2005, 03, "Mar", 09)
GlobalAnalysis(1312, 52, 2005, 04, "Aor", 10)
GlobalAnalysis(1313, 53, 2005, 05, "May", 11)
GlobalAnalysis(1314, 54, 2005, 06, "Jun", 12)
GlobalAnalysis(1315, 55, 2005, 07, "Jul", 01)
GlobalAnalysis(1316, 56, 2005, 08, "Aug", 02)
GlobalAnalysis(1317, 57, 2005, 09, "Sep", 03)
GlobalAnalysis(1318, 58, 2005, 10, "Oct", 04)
GlobalAnalysis(1319, 59, 2005, 11, "Nov", 05)
GlobalAnalysis(1320, 60, 2005, 12, "Dec", 06)

GlobalAnalysis(1309, 61, 2006, 01, "Jan", 07)
GlobalAnalysis(1310, 62, 2006, 02, "Feb", 08)
GlobalAnalysis(1311, 63, 2006, 03, "Mar", 09)
GlobalAnalysis(1312, 64, 2006, 04, "Aor", 10)
GlobalAnalysis(1313, 65, 2006, 05, "May", 11)
GlobalAnalysis(1314, 66, 2006, 06, "Jun", 12)
GlobalAnalysis(1315, 67, 2006, 07, "Jul", 01)
GlobalAnalysis(1316, 68, 2006, 08, "Aug", 02)
GlobalAnalysis(1317, 69, 2006, 09, "Sep", 03)
GlobalAnalysis(1318, 70, 2006, 10, "Oct", 04)
GlobalAnalysis(1319, 71, 2006, 11, "Nov", 05)
GlobalAnalysis(1320, 72, 2006, 12, "Dec", 06)
