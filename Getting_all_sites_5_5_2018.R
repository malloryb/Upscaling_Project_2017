...
#Created 5/7/2018
#Coming back to this 12-12-2018
#To-dos: 
#1) Clean up code 
#2) Add mesic sites to ML upscaling (later)
#3) Run global upscaling less dryland mask 
#4) Do train/test on 80% of sites and 20% of sites not on 80%/20% of observations!
#5) Potentially re-code cost function
#6) Explore diagnostic plots from RandomForest Explainer
